...
<table>
  <tr>
    ...
    <td align="center"><b>34,964</b><br/><sub>전처리 이벤트</sub></td>
...
| 구분 | 결과 | 의미 |
|---|---:|---|
| 최종 분류 AUC-ROC | **0.8284** | T0 시점에서 성과형 트렌딩 여부 예측 |
| F1-Score | **0.7681** | Precision과 Recall의 균형 확보 |
| Accuracy | **0.8076** | 전체 판단 정확도 |
| 회귀 R² | **0.5322** | 지속 시간 회귀 모델의 설명력 |
| 회귀 RMSE | **0.9147** | 로그/정규화 스케일 기준 오차 |
| 2일 이상 지속 AUC | **0.8708** | 장기 지속 후보 탐지 보조 모델 |
| 5일 이상 지속 AUC | **0.8429** | 실무 활용 가능한 구간 분류 성능 |
...
| 구성 | XGBoost + LightGBM + RandomForest |
| 버전 | v1.0.0 |
| 저장일 | 2026-05-04 |
